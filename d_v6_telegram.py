...
class ObjectTrackingSystem:
    def __init__(self, source_video_path, surface_polygon,bot_token,chat_id):
...
if __name__ == "__main__":
    ...
    tracker_system = ObjectTrackingSystem(source_video_path, surface_polygon,bot_token,chat_id)
    tracker_system.run()
